  ...
  const posts = [
    {
      ...
      content:
        "Excited to announce that I've been promoted to Senior Software Engineer! Thank you to everyone who supported me throughout this journey. The skills I learned during my time at university have been invaluable.",
      image:
    ...
    },
    {
      ...
      content:
        'Our research paper on "Machine Learning Applications in Healthcare" has been accepted for publication in Nature! Proud of our team\'s hard work.',
      likes: 87,
      comments: 15,
      timeAgo: "5 hours ago",
    },
    {
      ...
      content:
        "Just completed my internship at Microsoft! Looking forward to applying everything I learned in my final semester. Thank you to the career services team for their support.",
      image:
