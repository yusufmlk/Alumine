  ...
  const campaigns = [
    {
      ...
      description: 'Help us build a state-of-the-art computer science laboratory with the latest equipment for our students.',
    ...
    },
    {
      ...
      description: 'Support talented students from underprivileged backgrounds to pursue their dreams in higher education.',
    ...
    },
    {
      ...
      description: 'Fund cutting-edge research projects in artificial intelligence and sustainable technology.',
      category: 'Research',
      targetAmount: 300000,
      raisedAmount: 85000,
      contributors: 42,
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Your contributions help build a better future for students and advance education, research, and campus life.
          </p>
        </div>
                ...
                <Card key={campaign.id}>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="mb-4">
                      ...
                      <Progress value={calculateProgress(campaign.raisedAmount, campaign.targetAmount)} className="mb-2" />
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        <Avatar className="h-8 w-8">
                          ...
                          <AvatarFallback>
                            {campaign.organizer.name.split(' ').map(n => n[0]).join('')}
                          </AvatarFallback>
                        </Avatar>
                        <div>
                          <p className="text-sm font-medium">{campaign.organizer.name}</p>
                          <p className="text-xs text-muted-foreground">{campaign.organizer.role}</p>
                        </div>
                      </div>
                      <Button onClick={() => handleDonate(campaign.id, selectedAmount || customAmount)}>
                        Donate Now
                      </Button>
                    </div>
                  </CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <Button 
                    ...
                    onClick={() => handleDonate('general', selectedAmount || `$${customAmount}`)}
                  >
